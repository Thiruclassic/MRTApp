...
//var CHECKPOINT_SELECT_QUERY = "SELECT STATION_NAME,count(STATION_NAME),Lane_code FROM CHECKPOINTSTATION WHERE LANE_CODE IN (replaceString) group by (station_name) having count(station_name) >= 2"
